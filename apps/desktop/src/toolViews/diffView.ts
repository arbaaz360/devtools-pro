...
export const diffView: ToolView = {
  ...
  render(runtime) {
    ...
    sources.innerHTML = '<div class="compare-heading"><strong>Compare two text documents</strong><span>Files remain read only; pasted text is limited to 256 KiB.</span></div><div class="compare-sources"><section class="compare-source"><div class="compare-source-head"><strong>Left / original</strong><button type="button" class="outline-button" data-side="left">Open file…</button></div><p class="compare-source-name" data-name="left">No source selected</p><textarea data-paste="left" maxlength="262144" spellcheck="false" wrap="off" placeholder="Or paste up to 256 KiB"></textarea></section><section class="compare-source"><div class="compare-source-head"><strong>Right / revised</strong><button type="button" class="outline-button" data-side="right">Open file…</button></div><p class="compare-source-name" data-name="right">No source selected</p><textarea data-paste="right" maxlength="262144" spellcheck="false" wrap="off" placeholder="Or paste up to 256 KiB"></textarea></section></div>';
